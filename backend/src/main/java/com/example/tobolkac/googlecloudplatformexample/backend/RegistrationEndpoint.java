 ...
 */
@Api(name = "registration", version = "v1", namespace = @ApiNamespace(ownerDomain = "backend.googlecloudplatformexample.tobolkac.example.com", ownerName = "backend.googlecloudplatformexample.tobolkac.example.com", packagePath = ""))
